  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-indigo-50 to-white">
      ...
      <div className="relative h-[60vh] md:h-[80vh] w-full overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-indigo-600/50 to-purple-600/50 flex flex-col items-center justify-center text-white backdrop-blur-sm">
          <h1 className="text-4xl md:text-6xl font-bold mb-6 text-center px-4 animate-fade-in">
            Transform Your Space
          </h1>
          <p className="text-xl md:text-2xl mb-8 text-center max-w-2xl px-4 animate-slide-up">
            Discover our collection of premium furniture
          </p>
          <button className="bg-white text-indigo-600 px-8 py-3 rounded-full font-semibold flex items-center space-x-2 hover:bg-indigo-100 transition-all duration-300 hover:scale-105 hover:shadow-lg">
